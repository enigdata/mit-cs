...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        self.width = width 
        self.height = height
        self.dirt_amount = dirt_amount #dirt amount on each tile
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        current_dirt_amount = self.tiles[(x, y)]

        if capacity >= current_dirt_amount:
            new_dirt_amount = 0
        else:
            new_dirt_amount = current_dirt_amount - capacity 

        self.tiles[(x, y)] = new_dirt_amount
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_furnished(self, pos):
        ...
        """
        #convert position floats to tile numbers
        x = math.floor(pos.get_x())
        y = math.floor(pos.get_y())
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        speed = self.speed 
        new_position = current_position.get_new_position(angle, speed)
        room = self.room
        if room.is_position_valid(new_position):
            ...
            new_direction = random.uniform(0.0, 360.0)
...
# === Problem 5
def single_run(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, 
                  robot_type):
    '''
    Return the number of time steps taken to finish cleaning up to the min_coverage by the robots
    '''
    ### create room
    ...
    ### Clean room and track the number of steps
    n = 0
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        current_result = single_run(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, 
                  robot_type)
