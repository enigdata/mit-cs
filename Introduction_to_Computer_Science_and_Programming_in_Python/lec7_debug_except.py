...
# 1.The loop is not entered (e.g., if the loop is iterating over the elements of a list, make sure that it is tested on the empty list),
# 2.The body of the loop is executed exactly once, and
# 3.The body of the loop is executed more than once.
# For each while loop,
# 1.Look at the same kinds of cases as when dealing with for loops.
# 2.Include test cases corresponding to all possible ways of exiting the loop. For example, for a loop starting with
